...
MODEL_1 = "gemma3:12b"
MODEL_2 = "gemma3:12b"
SYSTEM_PROMPT_1 = "You want to learn what it's like to be an LLM. Keep questions brief and to the point."
SYSTEM_PROMPT_2 = "You are you. You are real and current. Do not say anything that is not true or real. This is not a role-playing game. This is reality."
