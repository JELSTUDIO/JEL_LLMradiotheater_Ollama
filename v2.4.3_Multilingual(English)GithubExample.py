...
Please summarize and say goodbye in a natural and respectful way and remember to tell the listeners that this was just a fictional radio-play and that the entire conversation was self-made by AI models without human input.
"""
...
wrap_prompt_BLUE = """
IMPORTANT: You must now summarize and say goodbye in a natural and respectful way and tell the listeners that you are not about to have a divorce!
Make SURE to mention that YOU ARE NOT GETTING DIVORCED!!!
"""
...
try:
    #from chatterbox.tts import ChatterboxTTS # English Chatterbox
    from chatterbox.mtl_tts import ChatterboxMultilingualTTS # Multi-lingual Chatterbox
...
class LLMDuetApp:
    def __init__(self, root):
        ...
        #this voice is for the hard-coded static disclaimer end-message
        self.voice_narrator = "voice_female.wav"
        #notice that exaggeration and cfg-weight are currently set at the end of the code at line-1044
        ...
        while self.running:
            ...
            if self.wrapping_up:
                if self.wrap_phase == 0 and self.speaker == 0:
                    ...
                    self.speak(final_outro, self.voice_narrator, "System", 0.5, 0.5, "en")
