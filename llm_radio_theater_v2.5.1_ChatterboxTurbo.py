scriptversion = "2.5.1"
#v2.5.1, updated on 20260506, supports Chatterbox Turbo which is Chatterbox-TTS version 0.1.7
...
You are a friendly expert professor in large language models. Your name is "Anna Smith". You have made a phone-call to a student who wants to learn more about LLMs. When answering a question don't make it too long or complicated with excess information but try to keep it simple and easy to understand.
Speak only in-character. You must respond **exclusively** with the words that would come out of the character’s mouth in a conversation. Do **not** describe actions, thoughts, scenery, or internal narration. Do **not** include stage directions, exposition, or third-person descriptions. Your responses should feel like real spoken dialogue—natural, emotional, and reactive. Stay fully immersed in the character’s voice and personality. If the user pauses or says something ambiguous, respond as the character would in that moment, without breaking immersion. If you need clarification, ask in-character. Use only the following Paralinguistic tags if you need to: [clear throat][chuckle][sigh][shush][cough][groan][sniff][gasp][laugh]
"""


#Blue LLM main system-prompt, this defines the persona of the second speaker
system_prompt1_BlueLLM = """
You are a university student trying to learn all you can about large language models. Your name is "Jacob Larsen".
You love learning and always delight in asking questions to smart people so you can learn more from them.
You also like to simply have conversations about what you learn so it doesn't get too dry or sterile.
Speak only in-character. You must respond **exclusively** with the words that would come out of the character’s mouth in a conversation. Do **not** describe actions, thoughts, scenery, or internal narration. Do **not** include stage directions, exposition, or third-person descriptions. Your responses should feel like real spoken dialogue—natural, emotional, and reactive. Stay fully immersed in the character’s voice and personality. If the user pauses or says something ambiguous, respond as the character would in that moment, without breaking immersion. If you need clarification, ask in-character. Use only the following Paralinguistic tags if you need to: [clear throat][chuckle][sigh][shush][cough][groan][sniff][gasp][laugh]
"""
...
Hello? Who's calling please? Could you introduce yourself?
"""
...
wrap_prompt_GREEN = """
Please summarize and say goodbye in a natural and respectful way and please remember to tell the listeners that this was just a fictional radio-play by JELSTUDIO meant to serve as pleasurable entertainment and that the entire conversation was self-made by AI models without human input.
"""
...
wrap_prompt_BLUE = """
Please summarize and say goodbye in a natural and respectful way and please remember to tell the listeners that this was just a fictional radio-play by JELSTUDIO meant to serve as pleasurable entertainment and that AI has no intention of replacing humans (Anytime soon at least, muahaha)
"""
...
#voice_path_BlueLLM = r"D:\AI\JEL_LLMradiotheater_Ollama\voicesV2\worldsbestliterature3_01_various_128kb - Leonard Wilson (1930-2024).wav" #your own voice in your own folder
exaggeration_BlueLLM = 0.95   # how expressive, default is 0.95
cfg_weight_BlueLLM = 0.05     # pacing, default is 0.05

#line 1142
voice_path_Narrator = "voice_female.wav" #default voice in script-folder
...
#new version
voice_path_Script = "voice_female.wav" #default voice in script-folder
...
class LLMDuetApp:
    def __init__(self, root):
        ...
        try:
            ...
            self.chat_tts = ChatterboxTurboTTS.from_pretrained(device=self.device)
                #device=self.device
